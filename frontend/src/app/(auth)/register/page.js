...
/**
 * Konggest — Registration Page
 * Premium design for user onboarding
 */
...
import styles from '../login/login.module.css'; // Reusing the ultra-attractive login styles
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Register will auto-login and redirection runs
    } catch (err) {
      const msg = err.message || err.error || err.detail || 'Une erreur est survenue lors de l\'inscription.';
      ...
      <div className={`${styles.card} ${styles.card_large}`}>
        ...
        <div className={styles.logoSection}>
          ...
          <p className={styles.subtitle}>
            Propulsez votre gestion RH au Gabon
          </p>
        </div>
